...
class Ui_SceneEditorWidget(object):
    ...
    def retranslateUi(self, SceneEditorWidget):
        ...
        self.add_graphics_combobox.setItemText(3, QCoreApplication.translate("SceneEditorWidget", u"lines", None))
        self.add_graphics_combobox.setItemText(4, QCoreApplication.translate("SceneEditorWidget", u"surfaces", None))
        self.add_graphics_combobox.setItemText(5, QCoreApplication.translate("SceneEditorWidget", u"contours", None))
        self.add_graphics_combobox.setItemText(6, QCoreApplication.translate("SceneEditorWidget", u"streamlines", None))
